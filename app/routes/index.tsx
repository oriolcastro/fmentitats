...
import { Agenda } from '../components/2026/Agenda'
...
export default createRoute(c => {
  return c.render(
    <>
      <section class="bg-fme-black relative h-[50vh] md:h-[66vh] lg:h-screen">
        ...
        <div class="relative z-10 flex h-full flex-col items-center justify-center bg-transparent p-4">
          ...
          <p class="font-heading mb-4 text-center text-6xl text-white md:text-8xl lg:text-9xl">2026</p>
          <p class="mb-10 text-center text-lg font-light text-white uppercase md:text-xl lg:text-2xl">
            Del 29 de juliol al 5 d'agost | Vilanova i la Geltrú
          </p>
          <a
            href="#programa"
    ...
    {
      title: "Festa Major d'Entitats 2026",
      description: "Descobreix tota la programació de l'edició 2026",
      socialImage: '',
    },
  )
})
